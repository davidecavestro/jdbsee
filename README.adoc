...
This is the POC for a command line tool providing access to relational
databases.


# Project status

The project has no official releases yet, though it is stable enough
to run queries using drivers from local jars.
