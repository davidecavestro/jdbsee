...
image:https://img.shields.io/github/commit-activity/y/davidecavestro/jdbsee.svg["GitHub commit activity the past week, 4 weeks, year"]
image:https://img.shields.io/github/languages/code-size/badges/shields.svg[GitHub code size in bytes]
image:https://img.shields.io/twitter/follow/davide_cavestro.svg?style=social[Follow @davide_cavestro, link={uri-twitter-davide}]
